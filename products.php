<?php include 'header.php'; ?>
   ...
   <div class="tubes-block" data-aos="fade-up">
      <div class="container">
         <div class="row">
            <div class="col-md-12" data-aos="zoom-in">
               <div class="title">
                  <h2><strong class="grey">Tubes</strong> Types</h2>
               </div>
            </div>
         </div>
            ...
            <div class="tubes-type-block">
               <div class="row">
                  <div class="col-md-4">
                        ...
                        <li class="nav-item">
                           <a class="nav-link active" id="type1-tab" data-toggle="tab" href="#type1" role="tab" aria-controls="type1" aria-selected="true">3A Stainless Steel Sanitary Tubes</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" id="type2-tab" data-toggle="tab" href="#type2" role="tab" aria-controls="type2" aria-selected="false">ASME BPE Stainless Steel Sanitary Tubes</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" id="type3-tab" data-toggle="tab" href="#type3" role="tab" aria-controls="type3" aria-selected="false">ISO / SMS Stainless Steel Sanitary Tubes</a>
                        </li>
                        <li class="nav-item">
                           <a class="nav-link" id="type4-tab" data-toggle="tab" href="#type4" role="tab" aria-controls="type4" aria-selected="false">BS 4825 Stainless Steel Sanitary Tubes</a>
                        </li>
                     </ul>
                  </div>
                  <div class="col-md-8">
